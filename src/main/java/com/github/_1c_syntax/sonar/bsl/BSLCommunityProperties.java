...
public final class BSLCommunityProperties {
  ...
  public static final String LANG_SERVER_FILE_EXTENSIONS_PROP_KEY = "sonar.bsl.file.suffixes";
  ...
  public static final String LANG_SERVER_FILE_EXTENSIONS_DEF_VALUE = ".bsl,.os";
  ...
  public static List<PropertyDefinition> getProperties() {
    return Arrays.asList(
      ...
      PropertyDefinition.builder(LANG_SERVER_ENABLED_KEY)
        ...
        .index(0)
        .build(),
      PropertyDefinition.builder(LANG_SERVER_FILE_EXTENSIONS_PROP_KEY)
        .name("BSL File suffixes")
        .description("List of file suffixes that will be scanned.")
        .category(BSL_CATEGORY)
        .defaultValue(LANG_SERVER_FILE_EXTENSIONS_DEF_VALUE)
        .onQualifiers(Qualifiers.PROJECT)
        .multiValues(true)
        .index(2)
        .build(),
