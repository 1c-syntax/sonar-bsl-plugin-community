...
class BSLPluginTest {
  ...
  private static final Version VERSION_25_4 = Version.create(25, 4);
  private final BSLPlugin bslPlugin = new BSLPlugin();

  @Test
  void testGetExtensions() {
    var runtime = SonarRuntimeImpl.forSonarQube(VERSION_25_4, SonarQubeSide.SCANNER, SonarEdition.COMMUNITY);
