...
//      .setProperty(ACCProperties.ENABLED_KEY, true)
//      .asConfig();
...
//    RulesDefinition.Repository repository = context.repository(ACCProperties.REPOSITORY_KEY);
...
//    Configuration config = new MapSettings()
//      .setProperty(ACCProperties.ENABLED_KEY, true)
//      .setProperty(ACCProperties.RULES_PATHS_KEY, "")
//      .asConfig();
//    ACCRuleDefinition ruleDefinition = new ACCRuleDefinition(config);
//    RulesDefinition.Context context = new RulesDefinition.Context();
//    ruleDefinition.define(context);
...
//    Configuration config = new MapSettings()
//      .setProperty(ACCProperties.ENABLED_KEY, true)
//      .setProperty(ACCProperties.RULES_PATHS_KEY, fileRules.getAbsolutePath() + "," + fileRulesSecond.getAbsolutePath())
//      .asConfig();
//    ACCRuleDefinition ruleDefinition = new ACCRuleDefinition(config);
//    RulesDefinition.Context context = new RulesDefinition.Context();
//    ruleDefinition.define(context);
